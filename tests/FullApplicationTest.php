...
use NourApi\Framework\Application;
use NourApi\Framework\Console\ConsoleServiceProvider;
use NourApi\Framework\Http\Request;
use Mockery as m;
...
class FullApplicationTest extends TestCase
{
    ...
    {
        $app = new Application;
        $app->instance(ExceptionHandler::class, $mock = m::mock('NourApi\Framework\Exceptions\Handler[report]'));
    ...
    public function testHandlingCommandsTerminatesApplication()
    {
        ...
        $kernel = $app[NourApi\Framework\Console\Kernel::class];
...
class LumenTestControllerWithMiddleware extends NourApi\Framework\Routing\Controller
{
    public function __construct(LumenTestService $service)
    {
