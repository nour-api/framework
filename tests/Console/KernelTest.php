...
use NourApi\Framework\Console\Kernel as ConsoleKernel;
use NourApi\Framework\Exceptions\Handler as ExceptionHandler;

class KernelTest extends \NourApi\Framework\Testing\TestCase
{
    /**
    ...
    public function testItCanRerouteToSymfonyEvent()
    {
        ...
        $this->artisan('cache:forget', ['key' => 'nourapi']);
    }
}
