...
use NourApi\Framework\Bus\PendingDispatch;
...
if (! function_exists('app')) {
     ...
     * @return mixed|\NourApi\Framework\Application
     */
...
if (! function_exists('redirect')) {
     ...
     * @return \NourApi\Framework\Http\Redirector|\Illuminate\Http\RedirectResponse
     */
    function redirect($to = null, $status = 302, $headers = [], $secure = null)
    {
        $redirector = new NourApi\Framework\Http\Redirector(app());
...
if (! function_exists('response')) {
     ...
     * @param  int  $status
     * @param  array  $headers
     * @return \Illuminate\Http\Response|\NourApi\Framework\Http\ResponseFactory
     */
    function response($content = '', $status = 200, array $headers = [])
    {
        $factory = new NourApi\Framework\Http\ResponseFactory;
